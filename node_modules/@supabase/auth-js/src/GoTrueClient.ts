...
import { localStorageAdapter, memoryLocalStorageAdapter } from '@supabase/auth-js/src/lib/local-storage'
...
import { stringToUint8Array, bytesToBase64URL } from '@supabase/auth-js/src/lib/base64url'
